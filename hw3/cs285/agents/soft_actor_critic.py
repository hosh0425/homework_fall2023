...
class SoftActorCritic(nn.Module):
    def __init__(
        ...
        self.num_actor_samples = 2 #num_actor_samples
    ...
    def update_critic(
        ...
        with torch.no_grad():
            ...
            target_values: torch.Tensor = reward + self.discount * (1 - done.to(torch.int)) * next_qs
    ...
    def actor_loss_reinforce(self, obs: torch.Tensor):
        ...
        with torch.no_grad():
            ...
            obs_tiled = torch.stack([obs for _ in range(self.num_actor_samples)], 0)
            q_values = self.critic(obs_tiled, action)
